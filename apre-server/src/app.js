...
// Add the call duration display route here (e.g., const callDurationRoute = require('./routes/reports/agent-performance/call-duration-display'))
const callDurationRoute = require('./routes/reports/agent-performance/call-duration-display');
...
// Add the call duration display route here (e.g., app.use('/api/reports/agent-performance/call-duration-display', callDurationRoute))
app.use('/api/reports/agent-performance/call-duration-display', callDurationRoute);
